                ...
                <tr>
                    ...
                    <td>
                        <form action="m_update_barang_detail.php" method="post">
                            <input type="hidden" name="id_detail_penjualan"
                            ...
                            <select name="id_barang" id="" onchange="this.form.submit()">
                                <?php
                                    ...
                                    <?php if ($barang['id_barang'] == $detail['id_barang']) echo "selected"; ?>>
                    ...
                    <form action="m_hitung_sub_total.php" method="post">
                        ...
                        <td><input type="number" name="jumlah_barang" value="<?= $detail['jumlah_barang'] ?>"
                                tabindex="1" onchange="this.form.submit()"></td>
                        <td>
